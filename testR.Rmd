...
```
  ...
  - The percentage is less than 1% that the chip packet will be morethan 2.1 gram.
A certain exprerimental drug claims a cure rate of higher than 75% for males with protaste cancer. Describe both the hypothesis.  

    - H0: The cure rate is less thab 75%
    - H1: The cure rate is higher than 75%
